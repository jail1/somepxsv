...
( function () {
    ...
    angular.module('calendar').constant('moment', window.moment);

    angular.module('calendar').factory('calendarTitle', calendarTitle);

    calendarTitle.$inject = ['moment', 'calendarConfig'];

    function calendarTitle(moment, calendarConfig) {
    ...
    angular.module('calendar').factory('calendarHelper', calendarHelper);

    calendarHelper.$inject = ['moment', 'calendarConfig'];

    function calendarHelper(moment, calendarConfig) {
    ...
    angular.module('calendar').service('calendarDebounce', calendarDebounce);

    calendarDebounce.$inject = ['$timeout'];

    function calendarDebounce($timeout) {
    ...
    angular.module('calendar').provider('calendarConfig', calendarConfig);
    ...
    angular.module('calendar').filter('calendarTruncateEventTitle', calendarTruncateEventTitle);
    ...
    angular.module('calendar').filter('calendarLimitTo', calendarLimitTo);

    function calendarLimitTo() {
    ...
    angular.module('calendar').directive('calendarDateModifier', calendarDateModifier);

    function calendarDateModifier() {
        return {
            restrict: 'A',
            controller: [
                '$element',
    ...
    angular.module('calendar').directive('calendarCollapseFeedback', calendarCollapseFeedback);

    calendarCollapseFeedback.$inject = ['$injector'];

    function calendarCollapseFeedback($injector) {
        ...
        return {
            ...
            controller: [
                ...
                function ($scope, $attrs, $element) {
                    var unbindWatcher = $scope.$watch($attrs.calendarCollapseFeedback, function (shouldCollapse) {
                        if (shouldCollapse) {
    ...
    angular.module('calendar').directive('mainCalendarYear', mainCalendarYear);

    function mainCalendarYear() {
        return {
            templateUrl: 'views/templates/calendarYearView.html',
            restrict: 'EA',
            require: '^mainCalendar',
            scope: {
                events: '=',
                currentDay: '=',
                onEventClick: '=',
    ...
    angular.module('calendar').directive('mainCalendarWeek', mainCalendarWeek);

    function mainCalendarWeek() {
        return {
            templateUrl: 'views/templates/calendarWeekView.html',
            restrict: 'EA',
            require: '^mainCalendar',
            scope: {
                events: '=',
    ...
    angular.module('calendar').directive('mainCalendarSlideBox', mainCalendarSlideBox);

    function mainCalendarSlideBox() {
        return {
            restrict: 'EA',
            templateUrl: 'views/templates/calendarSlideBox.html',
            replace: true,
            controller: [
                '$scope',
                '$sce',
    ...
    angular.module('calendar').directive('mainCalendarMonth', mainCalendarMonth);

    function mainCalendarMonth() {
        return {
            templateUrl: 'views/templates/calendarMonthView.html',
            restrict: 'EA',
            require: '^mainCalendar',
            scope: {
                events: '=',
    ...
    angular.module('calendar').directive('mainCalendarDay', mainCalendarDay);

    function mainCalendarDay() {
        return {
            templateUrl: 'views/templates/calendarDayView.html',
            restrict: 'EA',
            require: '^mainCalendar',
            scope: {
                events: '=',
    ...
    angular.module('calendar').directive('mainCalendar', mainCalendar);
