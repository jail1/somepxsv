( function () {
    ...
    angular.module('keyman', []).factory('keyboardManager', keyboardManager);
    ...
    function keyboardManager($window, $timeout) {
        ...
        keyboardManagerService.unbindAll = function () {
            angular.forEach(keyboardManagerService.keyboardEvent , function (binding) {
                var type = binding['event'],
                    elt = binding['target'],
                    callback = binding['callback'];
                if (elt.detachEvent) elt.detachEvent('on' + type, callback);
            ...
            delete keyboardManagerService.keyboardEvent;
            keyboardManagerService.keyboardEvent = {};
        };
        //
