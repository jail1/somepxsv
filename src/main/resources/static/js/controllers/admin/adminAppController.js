(function () {
    ...
    angular.module('photoX').controller('MainController', Controller);

    Controller.$inject = ['$controller', '$scope', '$rootScope', '$state', '$timeout', '$log', 'moment', '$mdDialog', '$mdSidenav', '$mdBottomSheet', '_'];

    function Controller($controller , $scope, $rootScope, $state, $timeout, $log, moment, $mdDialog, $mdSidenav, $mdBottomSheet, _) {
