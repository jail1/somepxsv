 ...
 *
 */
public class JodaTimeFormatProcessor extends
	 ...
	 * 
	 * @see
	 * org.thymeleaf.processor.attr.AbstractTextChildModifierAttrProcessor#getText
	 * (org.thymeleaf.Arguments, org.thymeleaf.dom.Element, java.lang.String)
	 */
	@Override
	protected String getText(Arguments arguments, Element element,
		...
		IStandardExpressionParser parser = StandardExpressions
		...
		DateTimeFormatter localFormatter = formatter.withLocale(arguments
				.getContext().getLocale());

		return result instanceof DateTime ? localFormatter
				.print((DateTime) result) : EMPTY;
	}
}