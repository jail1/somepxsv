                    ...
                    link: function (scope, element, attrs, controllersArr) {
                        ...
                        dragMove = function (e) {
                            ...
                            if (dragElm) {
                                ...
                                //Bogdan : signal which is the target
                                targetElm.addClass('md-toast error');
                                ...
                                if (!pos.dirAx) {
                                    ...
                                    if (isEmpty) { // it's an empty tree
                                        ...
                                        //Bogdan : targetElm is about to change, remove signal
                                        targetElm.removeClass('md-toast error');
                                        targetElm = targetNode.$element; // Get the element of ui-tree-node
                                        //Bogdan : add class to new target
                                        targetElm.addClass('md-toast error');
                                        ...
                                        if (targetNode.$parentNodesScope.accept(scope, targetNode.index())) {
                                            ...
                                            console.log('targetNode.username');
