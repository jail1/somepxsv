...
(function () {
    ...
    angular.module('nowReservation').service('ApplicationServices', applicationServices);
            ...
            $timeout(function () {
                ...
                var testEvents = [
                    ...
                    },
                   {
                        ...
                        product: 'Alergare usoara',
                        type: 'important',
                        startsAt: new Date(currentYear, currentMonth, currentDay - 1, 12, 0),
                        endsAt: new Date(currentYear, currentMonth, currentDay - 1, 22, 0),
                        editable: true,
                        deletable: true,
                        incrementsBadgeTotal: true
                    },
